...
blastp –db [DB_title] –query nt.fsa -outfmt 6 -out results.out  
...
$ blastp -db ~/data/blastDB_mibig2.0_prot/mibig_prot_seqs.fasta -query ~/data/prodigal/Escherichia_coli.faa -outfmt 7 -out ~/data/prodigal/Escherichia_coli.blast_7
```
